...
- `需求评审报告_{版本}_{ts}.md` —— 需求评审产物（四维评估 + 结构拆解 + 交互体验 + P0/P1/P2 澄清清单；HTML 可选）
- `用例评审报告_{版本}_{ts}.md` —— 用例评审产物（结构完整性 + 覆盖设计 + 文案可判定性 + 澄清清单；HTML 可选）
- `技术评审报告_{版本}_{ts}.md` —— 技术方案评审产物（方案完整性 + 风险识别 + 可测试性评估 + 澄清清单；HTML 可选）
